...
namespace Acme.ShoppingCart.Data {
    public class DatabaseContext : DbContext {
        ...
        public DatabaseContext(DbContextOptions<DatabaseContext> options, ISubjectPrincipal subjectPrincipal) : base(options) {
...
#pragma warning restore S3267 // Loops should be simplified with "LINQ" expressions
        ...
        private static void SetDateTime(ModelBuilder builder) {

...
- NuGet Package Sources:
  ...
  - http://oa-utility:81/nuget/develop (Call it: Enerbank ProGet)
...
\enerbank.prequalification\src\EnerBank.Prequalification.WebApi\build.json
...
- In Enerbank.Prequalifiation.Data, make changes to the database models to match the desired schema.

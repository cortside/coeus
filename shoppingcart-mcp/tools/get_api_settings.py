...
from .get_api_settings_models import get_api_settings_Input
from schemas.models import Acme_ShoppingCart_WebApi_Models_Responses_SettingsModel
...
async def get_api_settings(input: get_api_settings_Input) -> Acme_ShoppingCart_WebApi_Models_Responses_SettingsModel:
    ...
    try:
        ...
        with tracer.start_as_current_span("tool_call") as span:
            ...
            return Acme_ShoppingCart_WebApi_Models_Responses_SettingsModel.parse_obj(res)
    except ValidationError:
        tool_validation_errors_total.labels(tool="get_api_settings").inc()
        return Acme_ShoppingCart_WebApi_Models_Responses_SettingsModel(
            service=None,
            build=None,
            configuration=None
        )

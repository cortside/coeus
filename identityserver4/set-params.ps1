...
Copy-Item .\src\build.json .\src\EnerBank.IdentityServer.WebApi\build.json -force
Copy-Item .\src\build.json .\src\Enerbank.IdentityServer.WebApi.IntegrationTests\build.json -force

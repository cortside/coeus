...
Copy-Item .\src\build.json .\src\Acme.IdentityServer.WebApi\build.json -force
Copy-Item .\src\build.json .\src\Acme.IdentityServer.WebApi.IntegrationTests\build.json -force

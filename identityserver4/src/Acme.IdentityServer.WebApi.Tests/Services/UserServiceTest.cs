...
using Acme.IdentityServer.Exceptions;
...
namespace Acme.IdentityServer.Tests.Services {
    ...
    public class UserServiceTest : BaseTestFixture {
        ...
        private void SetupService(IIdentityServerDbContext dbContext) {
            ...
            service = new UserService(httpMock.Object, hashProviderMock.Object, loggerMock.Object, configuration, mockServiceProvider.Object);
        }
    }
}

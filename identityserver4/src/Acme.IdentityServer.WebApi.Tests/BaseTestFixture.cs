...
namespace Acme.IdentityServer.Tests {
    public abstract class BaseTestFixture : IDisposable {
        ...
        public IdentityServerDbContext GetDatabaseContext() {
            ...
            subjectMock.Setup(x => x.SubjectId).Returns(Guid.NewGuid());
            ...
            var dbOptions = new DbContextOptionsBuilder<IdentityServerDbContext>()
                ...
                .Options;
            return new IdentityServerDbContext(dbOptions, subjectMock.Object, httpMock.Object);
        }
    }
}

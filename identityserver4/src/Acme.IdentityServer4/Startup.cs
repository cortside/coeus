...
using EnerBank.IdentityServer.Controllers.Account;
using EnerBank.IdentityServer.Data;
using EnerBank.IdentityServer.EventHandlers;
using EnerBank.IdentityServer.Models;
using EnerBank.IdentityServer.Services;
using EnerBank.IdentityServer.WebApi.Assemblers;
using EnerBank.IdentityServer.WebApi.Assemblers.Implementors;
using EnerBank.IdentityServer.WebApi.Controllers;
using EnerBank.IdentityServer.WebApi.Controllers.ResetClientSecretController;
using EnerBank.IdentityServer.WebApi.Data;
using EnerBank.IdentityServer.WebApi.Helpers;
using EnerBank.IdentityServer.WebApi.Json;
using EnerBank.IdentityServer.WebApi.Security;
using EnerBank.IdentityServer.WebApi.Services;
using EnerBank.IdentityServer.WebApi.Services.ExtensionGrantValidators;
...
namespace EnerBank.IdentityServer.WebApi {
    ...
    public class Startup {
        ...
        private void ConfigureIdentityServer(IServiceCollection services) {
            ...
            if (Configuration.GetSection("azureActiveDirectory").Exists()) {
                authenticationBuilder.AddOpenIdConnect("AAD", "Azure Active Directory", options => {
                    ...
                    options.ClientId = Configuration["azureActiveDirectory:clientId"];
                    options.Scope.Add("openid");
                    options.Scope.Add("profile");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory) {
            ...
            // TODO: commented out until a rabbit instance can be setup for dev/test environments

...
using Enerbank.IdentityServer.WebApi.IntegrationTests.Helpers;
...
namespace Enerbank.IdentityServer.WebApi.IntegrationTests {
    public class IntegrationTestFixture : IDisposable {
        ...
        public IntegrationTestFixture() {
            ...
            IWebHostBuilder builder = new WebHostBuilder()
                ...
                .UseStartup<EnerBank.IdentityServer.WebApi.Startup>()
            ...
            EnerBank.IdentityServer.WebApi.Startup.Handler = testserver.CreateHandler();

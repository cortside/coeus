using Enerbank.IdentityServer.WebApi.IntegrationTests;
using Enerbank.IdentityServer.WebApi.IntegrationTests.Extensions;
...
namespace EnerBank.IdentityServer.WebApi.IntegrationTests.Tests.User {

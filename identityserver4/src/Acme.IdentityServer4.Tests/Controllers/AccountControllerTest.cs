...
namespace EnerBank.IdentityServer.Tests.Controllers {
    ...
    public class AccountControllerTest : BaseTestFixture {
        ...
        private readonly Mock<IConfigurationRoot> configMock;
        ...
        [Fact]
        public async Task ShouldRemoveSubjectGrantsOponLogout() {
            // arrange

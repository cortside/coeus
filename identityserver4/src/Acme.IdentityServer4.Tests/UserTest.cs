...
using EnerBank.IdentityServer.Exceptions;
using EnerBank.IdentityServer.Tests;
...
namespace EnerBank.IdentityServer.WebApi.Tests {
    public class UserTest : BaseTestFixture {
        ...
        public void ShouldUpdateUser() {
            ...
            // act
            user.Update(newUsername, newStatus, claimModels, new List<string>() { "enerbankusa.com", "enerbank.com" });
        ...
        public void ShouldFilterClaimsWhenUpdatingUser(string claimType) {
            ...
            // act 
            Assert.Throws<InvalidValueMessage>(() => user.Update("username", null, claimModels, new List<string>() { "enerbankusa.com", "enerbank.com" }));
        }
        ...
        public void ShouldValidateUsernameWhenUpdatingUser(string newUsername) {
            ...
            // act & assert
            Assert.Throws<InvalidValueMessage>(() => user.Update(newUsername, null, claimModels, new List<string>() { "enerbankusa.com", "enerbank.com" }));
        }
        ...
        public void ShoulSkipStatusUpdate() {
            ...
            // act
            user.Update(newUsername, null, claimModels, new List<string>() { "enerbankusa.com", "enerbank.com" });

...
namespace EnerBank.IdentityServer.Tests.Services {
    ...
    public class UserServiceTest : BaseTestFixture {
        ...
        public UserServiceTest() {
            ...
            configurationBuilder.AddInMemoryCollection(new Dictionary<string, string>() {
                {"RestrictedEmailDomains:0", "enerbankusa.com"},
                {"RestrictedEmailDomains:1", "enerbank.com"},
        ...
        [Fact]
        public async Task ShouldCheckEnerBankEmailWhenCreatingUser() {
            // arrange
            CreateUserModel model = new CreateUserModel() {
                Username = "username",
                Claims = new List<UserClaimModel>() {

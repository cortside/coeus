...
using EnerBank.IdentityServer.WebApi.Controllers.Client;
...
namespace EnerBank.IdentityServer.WebApi.Tests.Services {
    public class ClientServiceTest : BaseClientTest {
        ...
        public void DeleteClient_ShouldDeleteClient_ByAuthClientId() {
            ...
            IdentityServerDbContext = new IdentityServerDbContext(optionsBuilder.Options, mockSubjectPrincipal.Object, httpContextAccessorMock.Object);
        ...
        public void ShouldNotCreateClient_DuplicateClientId() {
            ...
            //act/assert
            Assert.Throws<BadRequestException>(() => clientsService.CreateClient(request));
        }
        ...
        public void ShouldNotUpdateClientSubClaim() {
            ...
            //assert
            Assert.Throws<BadRequestException>(() => clientsService.UpdateClient(id, request));
        }
        ...
        public void ShouldNotUpdateInvalidClient() {
            ...
            //assert
            Assert.Throws<BadRequestException>(() => clientsService.UpdateClient(id + 1, request)); //id+1 should not exist and throw
        }
        ...
        public void UpdateClientClaims_UpdatingSub_ShouldThrowError() {
            ...
            // Act / Assert
            Assert.Throws<BadRequestException>(() => clientsService.UpdateClientClaims(id, model));
        }

...
declare @id int
set @clientId='automation.lender1'
...
if not exists (select * from auth.ClientClaims where clientId=@id)
  BEGIN
	insert into auth.ClientClaims values(@id, 'groups', '11c24487-a582-4738-866d-f652a978a445')
	insert into auth.ClientClaims values(@id, 'sub', 'bb4a59a6-4967-08d6-0000-000000000000')	
  END

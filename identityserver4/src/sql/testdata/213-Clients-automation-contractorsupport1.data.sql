...
declare @id int
set @clientId='automation.contractorsupport1'
...
if not exists (select * from auth.ClientClaims where clientId=@id)
  BEGIN
	insert into auth.ClientClaims values(@id, 'groups', '2f327399-517c-4332-a06b-7a2a3d9fbb30')
	insert into auth.ClientClaims values(@id, 'sub', '625487a1-9d89-27e2-0000-000000000000')
  END

...
declare @id int
set @clientId='automation.fundingmanagement1'
...
if not exists (select * from auth.ClientClaims where clientId=@id)
  BEGIN
	insert into auth.ClientClaims values(@id, 'groups', '3d69a060-8aad-4bdb-9849-6e6bb78342d9')
	insert into auth.ClientClaims values(@id, 'sub', '918457a1-9a99-22d2-0000-000000000000')
  END

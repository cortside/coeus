...
Declare @devUrl varchar(200)='https://maintenance.dev.enerbank.com'
Declare @testUrl varchar(200)='https://maintenance.test.enerbank.com'
Declare @stageUrl varchar(200)='https://maintenance.stage.enerbank.com'
Declare @demoUrl varchar(200)='https://maintenance.demo.enerbank.com'
Declare @integrationUrl varchar(200)='https://maintenance.integration.enerbank.com'
Declare @uatUrl varchar(200)='https://maintenance.uat.enerbank.com'
Declare @prodUrl varchar(200)='https://maintenance.enerbank.com'
declare @id int

Declare @clientName varchar(200) ='CreditReports Api'
Declare @clientId varchar(200) ='creditreports-api'
Declare @id int
...
if (not exists(select * from auth.ClientClaims where clientid = @id and Type='sub' and Value = '33a68925-96e1-4afb-96ba-6ad016b1c9d6'))
  BEGIN
  	insert into auth.ClientClaims values(@id, 'sub', '33a68925-96e1-4afb-96ba-6ad016b1c9d6')
  END

...
if (not exists(select * from auth.Clients where clientId=@clientId))
  BEGIN
	...
	--Develop environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.dev.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.dev.enerbank.com')

	--Test environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.test.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.test.enerbank.com')

	--Staging environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.stage.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.stage.enerbank.com')

	--Demo environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.demo.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.demo.enerbank.com')

	--Integration environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.integration.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.integration.enerbank.com')

	--UAT environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.uat.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.uat.enerbank.com')
	
	--Production environment
	INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://fms.enerbank.com/logout')
	INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://fms.enerbank.com')
...
if (exists(select * from auth.Clients where ClientId=@clientId))
  BEGIN
    ...
    set @testPostLogoutRedirectUri = 'https://fms.test.enerbank.com/logout'
    ...
    set @origin = 'https://fms.test.enerbank.com'
    ...
    set @stagingPostLogoutRedirectUri = 'https://fms.stage.enerbank.com/logout'
    ...
    set @stagingOrigin = 'https://fms.stage.enerbank.com'
    ...
    set @demoPostLogoutRedirectUri = 'https://fms.demo.enerbank.com/logout'
    ...
    set @demoOrigin = 'https://fms.demo.enerbank.com'
    ...
    set @integrationPostLogoutRedirectUri = 'https://fms.integration.enerbank.com/logout'
    ...
    set @integrationOrigin = 'https://fms.integration.enerbank.com'
    ...
    set @uatPostLogoutRedirectUri = 'https://fms.uat.enerbank.com/logout'
    ...
    set @uatOrigin = 'https://fms.uat.enerbank.com'
    ...
    set @productionPostLogoutRedirectUri = 'https://fms.enerbank.com/logout'
    ...
    set @productionOrigin = 'https://fms.enerbank.com'
...
insert into @allowedRedirectUris values (N'https://fms.dev.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.dev.enerbank.com/silent-redirect')
insert into @allowedRedirectUris values (N'https://fms.test.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.test.enerbank.com/silent-redirect')
insert into @allowedRedirectUris values (N'https://fms.stage.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.stage.enerbank.com/silent-redirect')
insert into @allowedRedirectUris values (N'https://fms.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.enerbank.com/silent-redirect')
insert into @allowedRedirectUris values (N'https://fms.uat.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.uat.enerbank.com/silent-redirect')
insert into @allowedRedirectUris values (N'https://fms.demo.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.demo.enerbank.com/silent-redirect')
insert into @allowedRedirectUris values (N'https://fms.integration.enerbank.com/login-redirect')
insert into @allowedRedirectUris values (N'https://fms.integration.enerbank.com/silent-redirect')

...
if (not exists(select * from auth.Clients where clientId=@clientId))
  BEGIN
    ...
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.dev.enerbank.com')
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.test.enerbank.com')
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.stage.enerbank.com')
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.enerbank.com')
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.uat.enerbank.com')
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.demo.enerbank.com')
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://lenderapp.integration.enerbank.com')
  END
...
insert into @allowedRedirectUris values (N'https://lenderapp.dev.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.dev.enerbank.com/silent-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.test.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.test.enerbank.com/silent-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.stage.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.stage.enerbank.com/silent-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.enerbank.com/silent-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.uat.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.uat.enerbank.com/silent-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.demo.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.demo.enerbank.com/silent-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.integration.enerbank.com/auth-callback')
insert into @allowedRedirectUris values (N'https://lenderapp.integration.enerbank.com/silent-callback')
...
insert into @allowedCors values (N'https://lenderapp.dev.enerbank.com')
insert into @allowedCors values (N'https://lenderapp.test.enerbank.com')
insert into @allowedCors values (N'https://lenderapp.stage.enerbank.com')
insert into @allowedCors values (N'https://lenderapp.enerbank.com')
insert into @allowedCors values (N'https://lenderapp.uat.enerbank.com')
insert into @allowedCors values (N'https://lenderapp.demo.enerbank.com')
insert into @allowedCors values (N'https://lenderapp.integration.enerbank.com')

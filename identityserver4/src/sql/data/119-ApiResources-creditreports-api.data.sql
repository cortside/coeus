...
set @name ='creditreports.api'
set @pwHash = N'm8W/WQmTKqFzMBnlTc71EuDZsxVbyfMLBM2NSRBXQV8='
...
if (not exists(select * from auth.[ApiResources] where name=@name))
  BEGIN
	...
	-- That initial string is just a random string that works as a password: jdjIUDHSkdjhauds

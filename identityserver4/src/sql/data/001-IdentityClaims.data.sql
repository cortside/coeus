if not exists (select * from auth.IdentityClaims)
 begin
...
if not exists (select * from auth.IdentityClaims where type='groups' and IdentityResourceId=3)
  begin
	INSERT [AUTH].[IdentityClaims] ([IdentityResourceId], [Type]) VALUES (3, N'groups')
  end

...
if (exists(select * from auth.Clients where ClientId=@clientId))
  BEGIN
    ...
    insert into @allowedRedirectUris values (N'https://md.enerbank.com/login-redirect')
    insert into @allowedRedirectUris values (N'https://md.dev.enerbank.com/login-redirect')
    insert into @allowedRedirectUris values (N'https://md.test.enerbank.com/login-redirect')
    insert into @allowedRedirectUris values (N'https://md.stage.enerbank.com/login-redirect')
    insert into @allowedRedirectUris values (N'https://md.uat.enerbank.com/login-redirect')
    insert into @allowedRedirectUris values (N'https://md.demo.enerbank.com/login-redirect')
    ...
    insert into @allowedpostLogoutRedirects values (N'https://md.enerbank.com/logout')
    insert into @allowedpostLogoutRedirects values (N'https://md.dev.enerbank.com/logout')
    insert into @allowedpostLogoutRedirects values (N'https://md.test.enerbank.com/logout')
    insert into @allowedpostLogoutRedirects values (N'https://md.stage.enerbank.com/logout')
    insert into @allowedpostLogoutRedirects values (N'https://md.uat.enerbank.com/logout')
    insert into @allowedpostLogoutRedirects values (N'https://md.demo.enerbank.com/logout')

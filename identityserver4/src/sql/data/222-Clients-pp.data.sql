...
if (not exists(select * from auth.Clients where clientId=@clientId))
  BEGIN
    ...
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://portal-dev-admin.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientRedirectUris] ([ClientId], [RedirectUri]) VALUES (@id, N'https://portal-dev-admin.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://portal-dev-admin.enerbank.com')
	
	--Dev External environment
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://portal-dev.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientRedirectUris] ([ClientId], [RedirectUri]) VALUES (@id, N'https://portal-dev.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://portal-dev.enerbank.com')

    --Test Internal environment
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://portal-test-admin.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientRedirectUris] ([ClientId], [RedirectUri]) VALUES (@id, N'https://portal-test-admin.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://portal-test-admin.enerbank.com')
	
	--Test External environment
    INSERT [AUTH].[ClientPostLogoutRedirectUris] ([ClientId], [PostLogoutRedirectUri]) VALUES (@id, N'https://portal-test.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientRedirectUris] ([ClientId], [RedirectUri]) VALUES (@id, N'https://portal-test.enerbank.com/PartnerPortal/Login.aspx')
    INSERT [AUTH].[ClientCorsOrigins] VALUES (@id, 'https://portal-test.enerbank.com')
...
if (exists(select * from auth.Clients where ClientId=@clientId))
  BEGIN
    ...
    set @postLogoutRedirectUri = 'https://portal-dev-admin.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @redirectUri = 'https://portal-dev-admin.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @origin = 'https://portal-dev-admin.enerbank.com'
    ...
    set @postLogoutRedirectUri = 'https://portal-dev.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @redirectUri = 'https://portal-dev.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @origin = 'https://portal-dev.enerbank.com'
    ...
    set @postLogoutRedirectUri = 'https://portal-test-admin.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @redirectUri = 'https://portal-test-admin.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @origin = 'https://portal-test-admin.enerbank.com'
    ...
    set @postLogoutRedirectUri = 'https://portal-test.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @redirectUri = 'https://portal-test.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @origin = 'https://portal-test.enerbank.com'
    ...
    set @postLogoutRedirectUri = 'https://portal-admin.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @redirectUri = 'https://portal-admin.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @origin = 'https://portal-admin.enerbank.com'
    ...
    set @postLogoutRedirectUri = 'https://portal.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @redirectUri = 'https://portal.enerbank.com/PartnerPortal/Login.aspx'
    ...
    set @origin = 'https://portal.enerbank.com'

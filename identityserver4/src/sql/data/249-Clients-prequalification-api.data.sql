Declare @clientName varchar(200) ='Prequalification Api'
Declare @clientId varchar(200) ='prequalification-api'
Declare @id int
...
if (not exists(select * from auth.ClientScopes where clientid = @id and scope = 'decisionengine-api'))
  BEGIN
...
if (not exists(select * from auth.ClientClaims where clientid = @id and Type='sub' and Value = 'ab63bd1c-30da-4111-b702-35c0e7f0ac31'))
BEGIN
  insert into auth.ClientClaims values(@id, 'sub', 'ab63bd1c-30da-4111-b702-35c0e7f0ac31')
END

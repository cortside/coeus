...
Declare @devUrl varchar(200)='https://servicing.dev.enerbank.com'
Declare @testUrl varchar(200)='https://servicing.test.enerbank.com'
Declare @stageUrl varchar(200)='https://servicing.stage.enerbank.com'
Declare @demoUrl varchar(200)='https://servicing.demo.enerbank.com'
Declare @integrationUrl varchar(200)='https://servicing.integration.enerbank.com'
Declare @uatUrl varchar(200)='https://servicing.uat.enerbank.com'
Declare @prodUrl varchar(200)='https://servicing.enerbank.com'
declare @id int

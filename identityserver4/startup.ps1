...
$config.ConnectionStrings.AuthConnString = "Server=tcp:$($SQL_SERVER);Database=$($SQL_DATABASE);User Id=$($SQL_USER);Password=$($SQL_PASSWORD);Trusted_Connection=False;MultipleActiveResultSets=true"

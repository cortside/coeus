...
if ($PSScriptRoot.Contains(' ')) { 
    throw "Your working directory has a space in the path, which is not supported.  Wise up and move to C:\work\enerbank.users! And have a wonderful day, or evening!"
    exit
}
